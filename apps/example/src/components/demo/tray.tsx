    ...
    <Sheet>
      <SheetTrigger
        className={cn(
          ...
          active
            ? "border-agent-foreground/70 text-foreground hover:border-agent-foreground"
            : "border-border text-muted-foreground hover:border-agent-foreground/60 hover:text-foreground",
          className,
        )}
      >
        <span className="text-agent-foreground">▴</span>
        {label}
