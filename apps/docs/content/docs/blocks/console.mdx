---
title: Console
description: Development preview of a workbench for debugging and testing Pipecat agents — connect flow, media, transcripts, metrics, and live events in one drop-in block.
